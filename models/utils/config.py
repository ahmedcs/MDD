...
class Config():
    def __init__(self, config_file = 'default.cfg'):
        self.config_name = '.'.join(config_file.split('/')[-1].split('.')[:-1])
        self.dataset = 'reddit'
        ...
        # Set -1 devices frac to be imported from the real data
        self.low_end_dev_frac = -1
        self.moderate_dev_frac = -1
        self.high_end_dev_frac = -1
        '''
        ...
        with open(filename, 'r') as f:
            for line in f:
                ...
                try:
                    ...
                    elif line[0] == 'low_end_dev_frac':
                        self.low_end_dev_frac = float(line[1])
                    elif line[0] == 'moderate_dev_frac':
                        self.moderate_dev_frac = float(line[1])
                    elif line[0] == 'high_end_dev_frac':
                        self.high_end_dev_frac = float(line[1])
                    ...
                    elif line[0] == 'optimizer':
                        self.optimizer = str(line[1])
                    elif line[0] == 'fedprox':
